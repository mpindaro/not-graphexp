...
const default_node_color = "#e57373";
...
const default_edge_color = "#d1d1d1";
...
const use_curved_edges = false; // false;

//Colori di default dei nodi
let defaultColors = ["#e57373", "#d1c4e9","#bbdefb", "#b2dfdb", "#fff176", "#ffb74d"]
//Colori di default degli archi
let defaultEdgeColors = ["#757575", "#d1d1d1"]
